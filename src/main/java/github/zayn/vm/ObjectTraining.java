...
public class ObjectTraining {
    public static void main(String[] args) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        Object objectTraining = myLoader1.loadClass("github.zayn.vm.ObjectTraining").newInstance();
        Object objectTraining2 = myLoader2.loadClass("github.zayn.vm.ObjectTraining").newInstance();
